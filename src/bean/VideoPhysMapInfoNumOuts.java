...
/**
 * Class VideoPhysMapInfoNumOuts.
 * 
 * @version $Revision$ $Date$
 */
public class VideoPhysMapInfoNumOuts implements java.io.Serializable {
    ...
    public VideoPhysMapInfoNumOuts() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.VideoPhysMapInfoNumOuts
     */
    public static bean.VideoPhysMapInfoNumOuts unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.VideoPhysMapInfoNumOuts) Unmarshaller.unmarshal(bean.VideoPhysMapInfoNumOuts.class, reader);
    }
