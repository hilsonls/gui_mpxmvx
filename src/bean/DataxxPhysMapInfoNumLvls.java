...
/**
 * Class DataxxPhysMapInfoNumLvls.
 * 
 * @version $Revision$ $Date$
 */
public class DataxxPhysMapInfoNumLvls implements java.io.Serializable {
    ...
    public DataxxPhysMapInfoNumLvls() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.DataxxPhysMapInfoNumLvls
     */
    public static bean.DataxxPhysMapInfoNumLvls unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.DataxxPhysMapInfoNumLvls) Unmarshaller.unmarshal(bean.DataxxPhysMapInfoNumLvls.class, reader);
    }
