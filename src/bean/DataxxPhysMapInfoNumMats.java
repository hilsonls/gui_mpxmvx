...
/**
 * Class DataxxPhysMapInfoNumMats.
 * 
 * @version $Revision$ $Date$
 */
public class DataxxPhysMapInfoNumMats implements java.io.Serializable {
    ...
    public DataxxPhysMapInfoNumMats() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.DataxxPhysMapInfoNumMats
     */
    public static bean.DataxxPhysMapInfoNumMats unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.DataxxPhysMapInfoNumMats) Unmarshaller.unmarshal(bean.DataxxPhysMapInfoNumMats.class, reader);
    }
