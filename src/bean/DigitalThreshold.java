...
/**
 * Class DigitalThreshold.
 * 
 * @version $Revision$ $Date$
 */
public class DigitalThreshold implements java.io.Serializable {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.DigitalThreshold
     */
    public static bean.DigitalThreshold unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.DigitalThreshold) Unmarshaller.unmarshal(bean.DigitalThreshold.class, reader);
    }
