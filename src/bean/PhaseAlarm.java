 ...
 */
public class PhaseAlarm implements java.io.Serializable {
     ...
     * Field _threshold.
     */
    private bean.Threshold _threshold;
     ...
     */
    public bean.Threshold getThreshold(
    ) {
    ...
    public void setThreshold(
            final bean.Threshold threshold) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.PhaseAlarm
     */
    public static bean.PhaseAlarm unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.PhaseAlarm) Unmarshaller.unmarshal(bean.PhaseAlarm.class, reader);
    }
