...
/**
 * Class AudioPhysMapInfoNumOuts.
 * 
 * @version $Revision$ $Date$
 */
public class AudioPhysMapInfoNumOuts implements java.io.Serializable {
    ...
    public AudioPhysMapInfoNumOuts() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.AudioPhysMapInfoNumOuts
     */
    public static bean.AudioPhysMapInfoNumOuts unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.AudioPhysMapInfoNumOuts) Unmarshaller.unmarshal(bean.AudioPhysMapInfoNumOuts.class, reader);
    }
