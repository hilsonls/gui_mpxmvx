...
import bean.GpiSource;

/**
 * Class GpiSourceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class GpiSourceDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public GpiSourceDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GpiSource target = (GpiSource) object;
