...
import bean.ObjectErrorMsgSize;

/**
 * Class ObjectErrorMsgSizeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ObjectErrorMsgSizeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ObjectErrorMsgSizeDescriptor() {
        super();
        _xmlName = "size";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ObjectErrorMsgSize target = (ObjectErrorMsgSize) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return bean.ObjectErrorMsgSize.class;
    }
