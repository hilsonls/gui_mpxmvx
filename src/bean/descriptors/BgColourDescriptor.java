...
import bean.BgColour;

/**
 * Class BgColourDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BgColourDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public BgColourDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BgColour target = (BgColour) object;
