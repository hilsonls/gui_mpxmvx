...
/**
 * Class VidAudPropertiesDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class VidAudPropertiesDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public VidAudPropertiesDescriptor() {
        super();
        _xmlName = "vidAudProperties";
        ...
        //-- _vidAudSource
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(bean.VidAudSource.class, "_vidAudSource", "source", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                VidAudProperties target = (VidAudProperties) object;
                return target.getVidAudSource();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    VidAudProperties target = (VidAudProperties) object;
                    target.setVidAudSource( (bean.VidAudSource) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("bean.VidAudSource");
        desc.setHandler(handler);
        ...
        //-- validation code for: _vidAudSource
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _error
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(bean.Error.class, "_error", "error", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    VidAudProperties target = (VidAudProperties) object;
                    target.setError( (bean.Error) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
    ...
    public java.lang.Class getJavaClass(
        ...
        return bean.VidAudProperties.class;
    }
