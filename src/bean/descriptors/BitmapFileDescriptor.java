...
import bean.BitmapFile;

/**
 * Class BitmapFileDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BitmapFileDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public BitmapFileDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BitmapFile target = (BitmapFile) object;
