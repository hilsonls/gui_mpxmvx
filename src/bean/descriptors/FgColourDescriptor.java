...
import bean.FgColour;

/**
 * Class FgColourDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class FgColourDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public FgColourDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                FgColour target = (FgColour) object;
