...
/**
 * Class StopTimeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class StopTimeDescriptor extends bean.descriptors.ObjectIntPropertyDescriptor {
    ...
    public StopTimeDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                StopTime target = (StopTime) object;
