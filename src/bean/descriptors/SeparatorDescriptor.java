...
import bean.Separator;

/**
 * Class SeparatorDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SeparatorDescriptor extends bean.descriptors.ObjectIntPropertyDescriptor {
    ...
    public SeparatorDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Separator target = (Separator) object;
