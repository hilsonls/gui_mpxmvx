...
/**
 * Class VitcSourceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class VitcSourceDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public VitcSourceDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                VitcSource target = (VitcSource) object;
