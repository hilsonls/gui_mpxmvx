...
import bean.UmdPosition;

/**
 * Class UmdPositionDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class UmdPositionDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public UmdPositionDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                UmdPosition target = (UmdPosition) object;
