...
import bean.DestColour;

/**
 * Class DestColourDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class DestColourDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public DestColourDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DestColour target = (DestColour) object;
