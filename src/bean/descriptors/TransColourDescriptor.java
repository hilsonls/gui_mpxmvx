...
import bean.TransColour;

/**
 * Class TransColourDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TransColourDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public TransColourDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TransColour target = (TransColour) object;
