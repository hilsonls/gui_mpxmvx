...
import bean.StartTime;

/**
 * Class StartTimeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class StartTimeDescriptor extends bean.descriptors.ObjectIntPropertyDescriptor {
    ...
    public StartTimeDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                StartTime target = (StartTime) object;
