...
/**
 * Class NtpServerDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class NtpServerDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public NtpServerDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                NtpServer target = (NtpServer) object;
