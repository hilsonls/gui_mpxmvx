...
import bean.LowerNormal;

/**
 * Class LowerNormalDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class LowerNormalDescriptor extends bean.descriptors.ObjectIntPropertyDescriptor {
    ...
    public LowerNormalDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                LowerNormal target = (LowerNormal) object;
