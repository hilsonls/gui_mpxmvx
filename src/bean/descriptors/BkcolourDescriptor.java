...
import bean.Bkcolour;

/**
 * Class BkcolourDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BkcolourDescriptor extends bean.descriptors.ObjectStringPropertyDescriptor {
    ...
    public BkcolourDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Bkcolour target = (Bkcolour) object;
