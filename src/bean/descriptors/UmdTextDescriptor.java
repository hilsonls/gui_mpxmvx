...
/**
 * Class UmdTextDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class UmdTextDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UmdTextDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _text
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(bean.Text.class, "_text", "text", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UmdText target = (UmdText) object;
                    target.setText( (bean.Text) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
