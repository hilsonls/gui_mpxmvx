...
/**
 * Class FrontButtonDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class FrontButtonDescriptor extends bean.descriptors.ObjectIntPropertyDescriptor {
    ...
    public FrontButtonDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                FrontButton target = (FrontButton) object;
