...
/**
 * Class AudioPhysMapInfoNumMats.
 * 
 * @version $Revision$ $Date$
 */
public class AudioPhysMapInfoNumMats implements java.io.Serializable {
    ...
    public AudioPhysMapInfoNumMats() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.AudioPhysMapInfoNumMats
     */
    public static bean.AudioPhysMapInfoNumMats unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.AudioPhysMapInfoNumMats) Unmarshaller.unmarshal(bean.AudioPhysMapInfoNumMats.class, reader);
    }
