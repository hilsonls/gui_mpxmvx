...
/**
 * Class AudioPhysMapInfoNumLvls.
 * 
 * @version $Revision$ $Date$
 */
public class AudioPhysMapInfoNumLvls implements java.io.Serializable {
    ...
    public AudioPhysMapInfoNumLvls() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.AudioPhysMapInfoNumLvls
     */
    public static bean.AudioPhysMapInfoNumLvls unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.AudioPhysMapInfoNumLvls) Unmarshaller.unmarshal(bean.AudioPhysMapInfoNumLvls.class, reader);
    }
