 ...
 */
public class VidAudSource implements java.io.Serializable {
     ...
     * Method hasValid.
     * 
     * @return true if at least one Valid has been added
     */
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.VidAudSource
     */
    public static bean.VidAudSource unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.VidAudSource) Unmarshaller.unmarshal(bean.VidAudSource.class, reader);
    }
