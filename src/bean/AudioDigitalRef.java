...
/**
 * Class AudioDigitalRef.
 * 
 * @version $Revision$ $Date$
 */
public class AudioDigitalRef implements java.io.Serializable {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.AudioDigitalRef
     */
    public static bean.AudioDigitalRef unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.AudioDigitalRef) Unmarshaller.unmarshal(bean.AudioDigitalRef.class, reader);
    }
