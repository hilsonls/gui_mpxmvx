...
/**
 * Class DataxxPhysMapInfoNumOuts.
 * 
 * @version $Revision$ $Date$
 */
public class DataxxPhysMapInfoNumOuts implements java.io.Serializable {
    ...
    public DataxxPhysMapInfoNumOuts() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.DataxxPhysMapInfoNumOuts
     */
    public static bean.DataxxPhysMapInfoNumOuts unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.DataxxPhysMapInfoNumOuts) Unmarshaller.unmarshal(bean.DataxxPhysMapInfoNumOuts.class, reader);
    }
