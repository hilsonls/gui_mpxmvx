...
/**
 * Class DataxxPhysMapInfoNumDass.
 * 
 * @version $Revision$ $Date$
 */
public class DataxxPhysMapInfoNumDass implements java.io.Serializable {
    ...
    public DataxxPhysMapInfoNumDass() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.DataxxPhysMapInfoNumDass
     */
    public static bean.DataxxPhysMapInfoNumDass unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.DataxxPhysMapInfoNumDass) Unmarshaller.unmarshal(bean.DataxxPhysMapInfoNumDass.class, reader);
    }
