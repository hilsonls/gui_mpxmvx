 ...
 */
public class SnellMatrixIn implements java.io.Serializable {
    ...
    /**
     * keeps track of state for field: _con
     */
    private boolean _has_con;
    ...
    /**
     * Returns the value of field 'con'.
     * 
     * @return the value of field 'Con'.
     */
    public int getCon(
    ) {
        return this._con;
     ...
     * Method hasCon.
     * 
     * @return true if at least one Con has been added
     */
    public boolean hasCon(
    ) {
        return this._has_con;
    }
    ...
    /**
     * Sets the value of field 'con'.
     * 
     * @param con the value of field 'con'.
     */
    public void setCon(
            final int con) {
        this._con = con;
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.SnellMatrixIn
     */
    public static bean.SnellMatrixIn unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.SnellMatrixIn) Unmarshaller.unmarshal(bean.SnellMatrixIn.class, reader);
    }
