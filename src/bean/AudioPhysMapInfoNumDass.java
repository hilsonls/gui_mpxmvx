...
/**
 * Class AudioPhysMapInfoNumDass.
 * 
 * @version $Revision$ $Date$
 */
public class AudioPhysMapInfoNumDass implements java.io.Serializable {
    ...
    public AudioPhysMapInfoNumDass() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.AudioPhysMapInfoNumDass
     */
    public static bean.AudioPhysMapInfoNumDass unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.AudioPhysMapInfoNumDass) Unmarshaller.unmarshal(bean.AudioPhysMapInfoNumDass.class, reader);
    }
