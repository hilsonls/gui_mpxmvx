...
/**
 * Class VideoPhysMapInfoNumLvls.
 * 
 * @version $Revision$ $Date$
 */
public class VideoPhysMapInfoNumLvls implements java.io.Serializable {
    ...
    public VideoPhysMapInfoNumLvls() {
        super();
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled bean.VideoPhysMapInfoNumLvls
     */
    public static bean.VideoPhysMapInfoNumLvls unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (bean.VideoPhysMapInfoNumLvls) Unmarshaller.unmarshal(bean.VideoPhysMapInfoNumLvls.class, reader);
    }
