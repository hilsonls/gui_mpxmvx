 ...
 * @author Antonio
 */
public class ProtocolsSnellVideoPanel extends JPanelBGGradient {
    ...
    ProtocolsSnellVideoPanel(Video bean) {
        setLayout(null);
        ...
        routerTable.getColumnModel().getColumn(1).setCellEditor(new BoundedIntegerCellEditor(bean.getVideoPhysMapInfo().getNumMats().getMin(), bean.getVideoPhysMapInfo().getNumMats().getMax()));
        routerTable.getColumnModel().getColumn(2).setCellEditor(new BoundedIntegerCellEditor(bean.getVideoPhysMapInfo().getVideoPhysMapInfoNumLvls().getMin(), bean.getVideoPhysMapInfo().getVideoPhysMapInfoNumLvls().getMax()));
        routerTable.getColumnModel().getColumn(3).setCellEditor(new BoundedIntegerCellEditor(bean.getVideoPhysMapInfo().getVideoPhysMapInfoNumOuts().getMin(), bean.getVideoPhysMapInfo().getVideoPhysMapInfoNumOuts().getMax()));
        routerTable.getColumnModel().getColumn(4).setCellEditor(new BoundedIntegerCellEditor(bean.getVideoPhysMapInfo().getNumDass().getMin(), bean.getVideoPhysMapInfo().getNumDass().getMax()));
...
//        menuItemAction.setFont(getFont().deriveFont(Font.BOLD));
    ...
    private class MyTableModel extends AbstractTableModel {
        ...
        public MyTableModel() {
            maxIns = bean.getVideoPhysMapInfo().getVideoPhysMapInfoNumIns().getVal();
            data = new Object[maxIns][6];
            Iterator it = bean.getVideoPhysIns().iterateIn();
        ...
        private void save() {
            bean.getVideoPhysIns().removeAllIn();
